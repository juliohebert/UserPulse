...
// Usa o domínio configurado para o widget; sem configuração, aponta para a API
// em :3333 no Vite dev e para a própria origem no build de produção.
const WIDGET_ORIGIN = resolverOrigemTestador({
  widgetUrl: import.meta.env.VITE_USERPULSE_WIDGET_URL,
...
// com widget local, tour auto-iniciado e tenant resolvido pela public_key.
export function testEmbedUrl(tour: Pick<TourGuiado, 'slug'>, publicKey: string): string {
  return montarTestEmbedUrl(WIDGET_ORIGIN, tour.slug, publicKey)
}
