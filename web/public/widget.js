(function () {
  ...
  function ensureStyles() {
    ...
    style.textContent = [
      ...
      '.up-modal{position:static;width:100%;max-width:520px;background:#fff;border:1px solid #c2c6d6;border-radius:16px;box-shadow:0 24px 70px rgba(11,28,48,.22);overflow:hidden;display:flex;flex-direction:column;max-height:calc(100vh - 32px)}',
      ...
      '.up-body{padding:18px 20px 20px;display:flex;flex-direction:column;gap:14px;overflow-y:auto;flex:1;min-height:0}',
      ...
      '@media (max-width:600px){.up-widget-overlay{padding:8px}.up-modal{max-height:calc(100vh - 16px);border-radius:12px}.up-modal-header{padding:12px 16px}.up-body{padding:14px 16px 16px}.up-scale{gap:2px}.up-score{height:30px;font-size:11px;min-width:20px}.up-media img{max-height:160px}}',
