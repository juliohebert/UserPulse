          ...
          .then(function (campanha) {
            ...
            if (!aparenciaFetch && campanha.sistema) {
              ...
              aparenciaPromise = afSlug.pronta.then(function (ap) {
                aplicarEAtualizarAparencia(ap, 'campanha por slug (sistema da campanha)');
                return ap;
              });
              afSlug.real.then(function (apReal) {
                if (apReal && !aparenciaValoresIguais(apReal, tourState.aparencia)) {
                  aplicarEAtualizarAparencia(apReal, 'correção tardia (slug)');
                }
              }).catch(function () {});
            }
            resetRoot();
